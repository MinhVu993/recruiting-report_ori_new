                ...
                <table class="table table-bordered" style="margin-top: 10px;">
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="text-align: left; padding-bottom: 20px;">
                            ...
                            Điện thoại di động手機 {{ candidate.data.regTel || candidate.data.commTel || '' }}
                        </td>
                        <td colspan="3" style="text-align: left; padding-bottom: 20px; ">
                    ...
                    <tr>
                        <td colspan="12" style="text-align: left; padding-bottom: 20px;">
                            Địa chỉ thường trú 戶籍住址: {{ candidate.data.regAddress || '' }}
                        </td>
                    </tr>
                    <tr>
                        <td colspan="12" style="text-align: left;padding-bottom: 20px;">Địa chỉ liên hệ 聯絡地址: {{
                            candidate.data.commAddress || candidate.data.regAddress || '' }}</td>
                        </tr>
                        <tr>
                            <td colspan="12" class="text-center" style="padding: 5px"> <strong>Kinh nghiệm công việc 工作經驗:</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" class="text-center">Tên công ty đã từng làm <br/>公司名稱</td>
                                    <td colspan="2" class="text-center">Thời gian làm việc<br/>工作年資</td>
                                    <td colspan="2" class="text-center">Chức vụ <br/>職務</td>
                                    <td colspan="2" class="text-center">Tên công ty đã từng làm<br/>公司名稱</td>
                                    <td colspan="2" class="text-center">Thời gian làm việc<br/>工作年資</td>
                                    <td colspan="2" class="text-center">Chức vụ<br/>職務</td>
                                </tr>
                                <tr>
                                    <td colspan="2" class="text-center" style="height:35px"></td>
                                    <td colspan="2" class="text-center" style="height:35px"></td>
                                    <td colspan="2" class="text-center" style="height:35px"></td>
                                    <td colspan="2" class="text-center" style="height:35px"></td>
                                    <td colspan="2" class="text-center" style="height:35px"></td>
                                ...
                                <tr>
                                    <td colspan="8" style="text-align: left;">Kiến thức an toàn lao động 職場安全衛生知識     :
                                ...
                                <tr>
                                    <td colspan="4" style="padding-bottom: 50px; text-align: left;">Ký tên 簽名: </td>
                                    <td colspan="4" style="padding-bottom: 50px;text-align: left;">Ký tên 簽名: </td>
                                    <td colspan="4" style="padding-bottom: 50px;text-align: left;">Ký tên 簽名: </td>
                                </tr>
                                <tr>
